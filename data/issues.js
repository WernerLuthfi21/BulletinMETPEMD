...
window.METP_ISSUES = [
  {
    ...
    /* ------------------------------------------------------------------
       SPREAD: the real, data-driven page content — one physical spread
       per issue, left + right controlled completely independently. This
       is what actually renders in the binder now (see js/binder.js);
       `pages` above stays only as the source for the "Original" PDF link.
       To add a page, or leave one side blank, just edit `enabled` and
       `blocks` below — no frontend code needs to change.
       ------------------------------------------------------------------ */
    spread: {
      left: {
        enabled: true,
        blocks: [
          { type: "label", text: "AUGUST 2026 \u00B7 CONFIDENTIAL \u00B7 ACTIVITY HIGHLIGHT", variant: "tag" },
          { type: "heading", text: "Material Engineering & Technical Planning", level: 2 },
          { type: "subheading", text: "Monthly Bulletin \u2014 Issue #01" },
          { type: "divider" },
          { type: "heading", text: "Material Goes to Lotte Chemical", level: 1 },
          { type: "label", text: "Resin Localization Initiative" },
          { type: "text", text: "On 19-21 August 2026, Material Engineering visited Lotte Chemical's Cilegon & Cikarang Plant to explore its potential for supporting resin localization. As the next step, Material Engineering aims to accelerate the localization process, targeting to apply in T-D Project (D90N/91N) through the use of locally sourced resin." },
          { type: "divider" },
          { type: "heading", text: "R&D Facility Confirmation @Qualis Indonesia", level: 2 },
          { type: "text", text: "EMD Management conducted a genba visit to confirm Qualis' evaluation capabilities as a resin material development partner. Qualis has facilities to perform cut-body and vibration testing inside a thermal chamber." },
          { type: "divider" },
          { type: "heading", text: "EMD QCP as 2nd Winner in QCC Grand Convention 2026", level: 2 },
          { type: "text", text: "After decades of struggle, EMD finally secured 2nd place in QCP at QCC Company, driven by strong collaboration between Management, the QCC Promotion Team led by Lutful, and the VPE-PBMD Team (Nico, Danang & Odel). Next: join the National Quality Circle Competition in TKMPN (Temu Karya Mutu & Produktivitas Nasional) in Padang (Nov. '26)." }
        ]
      },
      right: {
        enabled: true,
        blocks: [
          { type: "heading", text: "Recycle 101", level: 2 },
          { type: "label", text: "Feasibility Study with Amiga Polimer Indonesia" },
          { type: "text", text: "Taking the first step toward circularity, Material Engineering kicked off its recycled plastics study with a plant visit to Amiga Polimer Indonesia, assessing its process and capabilities. With more suppliers to explore, the team is taking the first steps toward recycled vehicle parts and a circular economy." },
          { type: "divider" },
          { type: "heading", text: "Enabling WFH", level: 2 },
          { type: "text", text: "In preparation for full WFH in September, TP strengthened remote access through a common folder with PuD and Global Protection installation across EMD PCs. TP & TMC-EDC successfully cleared WARD System delivery errors, enabling 553 RDDPs and 4,143 Drawings to be delivered." },
          { type: "divider" },
          { type: "heading", text: "Natural Fiber Development", level: 2 },
          { type: "label", text: "From a Good Old Coconut" },
          { type: "text", text: "Nature proves its potential! TMMIN starts to promote natural material implementation; coco fiber is being developed as a substitute for glass wool in the insulator hood. The trial with Tier 1 Part Maker Candidate achieved 50% better cycle time. Appearance has been confirmed OK; further testing will be conducted to confirm performance." },
          { type: "divider" },
          { type: "heading", text: "An Insight from GIIAS 2026 \u2014 Honda Super-ONE", level: 2 },
          { type: "text", text: "This Honda's front grille uses recycled materials sourced from discarded Honda bumpers. This innovative technology not only introduces a new approach to automotive design but also supports carbon neutrality and environmental sustainability." },
          { type: "divider" },
          { type: "quote", text: "Plan the work, then work the plan.", cite: "Editor chief: M. Fuadi \u00B7 Editors: Ayu, Werner" },
          { type: "button", text: "Open the full PDF", href: "assets/issues/2026-08.pdf" }
        ]
      }
    },
